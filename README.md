...
Converts Nanopolish and Tombo alignments to UNCALLED DTW alignment tracks.
...
Displays a raw signal genome browser of one or two alignment tracks, including interactive plotting options and summary statistics.
