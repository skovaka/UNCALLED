...
_COMMON_OBJS=mapper.o seed_tracker.o range.o event_detector.o normalizer.o read_buffer.o fast5_reader.o event_profiler.o paf.o
...
_DTW_OBJS=dtw_test.o fast5_reader.o read_buffer.o normalizer.o event_detector.o range.o event_profiler.o
